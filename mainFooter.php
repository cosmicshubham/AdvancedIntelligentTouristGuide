			...
			<div class="row">
				...
				<div class="col-lg-4 col-md-4 col-sm-6">
					<a class="fh5co-card-item" href="login.php">
						...
						<div class="fh5co-text">
							<h2>Goa, India</h2>
							<p>Goa is a state in western India with coastlines stretching along the Arabian Sea. Its long history as a Portuguese colony prior to 1961 is evident in its preserved 17th-century churches and the area’s tropical spice plantations.</p>
				...
				<div class="col-lg-4 col-md-4 col-sm-6">
					<a class="fh5co-card-item" href="login.php">
						...
						<div class="fh5co-text">
							<h2>Leh Ladakh</h2>
							<p>Ladakh is a region in the Indian state of Jammu and Kashmir that currently extends from the Kunlun mountain range to the main Great Himalayas to the south, inhabited by people of Indo-Aryan and Tibetan descent.</p>
							<p><span class="btn btn-primary">Schedule a Trip</span></p>
						</div>
					</a>
				</div>
				...
				<div class="col-lg-4 col-md-4 col-sm-6">
					<a class="fh5co-card-item" href="login.php">
						...
						<div class="fh5co-text">
							<h2>Agra</h2>
							<p>Agra is a city in northern India’s Uttar Pradesh state. It's home to the iconic Taj Mahal, a mausoleum built for the Mughal ruler Shah Jahan’s wife, Mumtaz Mahal (who died in childbirth in 1631). The imposing main building features a massive dome and intricately carved white marble inlaid with precious stones.</p>
							<p><span class="btn btn-primary">Schedule a Trip</span></p>
						</div>
					</a>
				</div>
			...
			<div class="row">
				<div class="col-md-4 col-sm-6">
					<div class="feature-center animate-box" data-animate-effect="fadeIn">
						...
						<h3>Update you user preferences</h3>
						<p>We provide exhaustive list of tags that help us suggesting locations to you.</p>
					</div>
				</div>
				<div class="col-md-4 col-sm-6">
					<div class="feature-center animate-box" data-animate-effect="fadeIn">
						...
						<h3>Explore the suggest places</h3>
						<p>Ratings, places, hotels, restaurants can be easily found in the description of the places.</p>
					</div>
				</div>
				<div class="col-md-4 col-sm-6">
					<div class="feature-center animate-box" data-animate-effect="fadeIn">
						...
						<h3>Pack your bags and start travelling</h3>
						<p>Stay connected with us, and we will help you finding places during the tour.</p>
					</div>
				</div>
	...
	<!--<div id="gtco-subscribe">
		<div class="gtco-container">
			<div class="row animate-box">
				<div class="col-md-8 col-md-offset-2 text-center gtco-heading">
					<h2>Customer Care</h2>
					<p>Provide your phone number or email and we'll contact you as soon as possible.</p>
				</div>
			</div>
			<div class="row animate-box">
					...
					<form class="form-inline">
						<div class="col-md-6 col-sm-6">
							<div class="form-group">
								...
								<input type="email" class="form-control" id="email" placeholder="Your Email/Phone">
							</div>
						</div>
						<div class="col-md-6 col-sm-6">
