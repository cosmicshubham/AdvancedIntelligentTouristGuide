...
<div class="col-lg-12">
  <div class="card">
    <div class="card-header"><strong>Interests</strong></div>
    <div class="card-body card-block">
      <div class="form-group">
        <label for="vat" class=" form-control-label">Add and Remove Interests</label>
        <input type="text" id="vat"  placeholder="Enter a interest" class="form-control col-lg-12">
        <br>
        <input type="text" id="vat"  placeholder="Enter a interest" class="form-control col-lg-12">
        <br>
        <input type="text" id="vat"  placeholder="Enter a interest" class="form-control col-lg-12">
